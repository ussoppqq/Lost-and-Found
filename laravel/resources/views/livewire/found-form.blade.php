  ...
  <div class="mx-auto w-full max-w-screen-sm sm:max-w-2xl lg:max-w-4xl px-3 sm:px-6">
    <div class="w-full bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8">
      ...
      <div class="text-center mb-5 sm:mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">Fill out the form below with details about the item you found.</p>
      </div>
      ...
      <form wire:submit.prevent="submit" class="space-y-5">
        ...
        <div class="lg:hidden">
          ...
          @if ($step === 1)
            <div class="space-y-4">
              ...
              {{-- Date & Time Found --}}
              <div>
                <label for="date_found" class="block text-sm font-semibold text-gray-900 mb-2">
                  Date & Time Found <span class="text-gray-500 text-xs font-normal">(optional)</span>
                </label>
                <input id="date_found" type="datetime-local" wire:model.defer="date_found"
          ...
          @if ($step === 3)
            <div class="space-y-4">
              ...
              <div>
                ...
                <input type="file" accept="image/*" multiple class="hidden" wire:model="photos" id="foundPhotosMobile">
                
                @if(empty($photos))
                  <button type="button" onclick="document.getElementById('foundPhotosMobile').click()"
        ...
        <div class="hidden lg:block space-y-6">
          ...
          <div class="space-y-4">
            ...
            {{-- Date & Time Found --}}
            <div>
              <label for="date_found_desktop" class="block text-sm font-semibold text-gray-900 mb-2">
                Date & Time Found <span class="text-gray-500 text-xs font-normal">(optional)</span>
              </label>
              <input id="date_found_desktop" type="datetime-local" wire:model.defer="date_found"
                     class="w-full px-4 py-3 text-base rounded-xl border-2 border-gray-300 focus:border-gray-800 focus:ring-2 focus:ring-gray-800 focus:ring-offset-0">
              @error('date_found') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
              <p class="text-xs text-gray-500 mt-1">Timezone: WIB (GMT+7)</p>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input type="file" accept="image/*" multiple class="hidden" wire:model="photos" id="foundPhotosDesktop">
              
              @if(empty($photos))
                <button type="button" onclick="document.getElementById('foundPhotosDesktop').click()"
      ...
      <p class="mt-6 text-center text-sm text-gray-500 leading-relaxed">
        Your information will help the owner reclaim their item.<br class="hidden sm:inline"> Thank you for reporting.
      </p>
    </div>
  </div>
</div>