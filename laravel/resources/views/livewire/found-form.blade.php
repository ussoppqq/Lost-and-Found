{{-- resources/views/livewire/report-found-item.blade.php --}}
...
<div x-data="{ loading: false }"
    ...
    <div class="w-full max-w-5xl">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-green-600 to-emerald-600 shadow-lg mb-4">
            ...
            <p class="mt-3 text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                Help us reunite items with their owners—every detail counts.
            </p>
        </div>
            ...
            <div class="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                <form wire:submit.prevent="submit" @submit="loading = true" class="p-6 sm:p-8 lg:p-10">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl border border-green-200 p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="item_name" required
                                           class="w-full rounded-xl border-gray-300 focus:border-green-600 focus:ring-green-600/20 placeholder:text-gray-400 transition"
                                ...
                                <div>
                                    ...
                                    <textarea rows="4" wire:model.defer="description" required
                                              class="w-full rounded-xl border-gray-300 focus:border-green-600 focus:ring-green-600/20 placeholder:text-gray-400 transition resize-none"
                                              placeholder="Brand, color, condition, special features, etc."></textarea>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gradient-to-br from-emerald-50 to-white rounded-2xl border border-emerald-200 p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                                <div class="flex items-center gap-3 mb-6">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="tel" wire:model.lazy="phone" required
                                                   class="w-full pl-12 rounded-xl border-gray-300 focus:border-emerald-600 focus:ring-emerald-600/20 placeholder:text-gray-400 transition"
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">
                                            Location Found <span class="text-gray-500 font-normal">(optional)</span>
                                        </label>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <input type="text" wire:model.defer="location"
                                                   class="w-full pl-12 rounded-xl border-gray-300 focus:border-emerald-600 focus:ring-emerald-600/20 placeholder:text-gray-400 transition"
                                                   placeholder="e.g. Near Building A, 2nd Floor">
                                        </div>
                            ...
                            <!-- Upload Image Card -->
                            <div class="bg-gradient-to-br from-teal-50 to-white rounded-2xl border border-teal-200 p-6 shadow-md hover:shadow-lg transition-shadow duration-300"
                                ...
                                <div :class="isDropping ? 'border-green-600 bg-green-50/50' : 'border-gray-300 bg-white'"
                                    ...
                                    @if ($photo)
                                        <div class="flex flex-col items-center gap-4">
                                            ...
                                            <div class="flex gap-3">
                                                <button type="button" @click="openFile()"
                                                        class="px-4 py-2 text-sm font-semibold rounded-lg bg-green-600 text-white hover:bg-green-700 transition active:scale-95">
                                                    Change Image
                                                </button>
                    ...
                    <div class="mt-8">
                        <button type="submit" :disabled="loading"
                                class="w-full inline-flex items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4 font-bold text-white shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200">
                            <svg x-show="loading" class="h-5 w-5 animate-spin" viewBox="0 0 24 24" fill="none">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                            </svg>
                            <span x-text="loading ? 'Submitting Your Report...' : 'Submit Found Item Report'" class="text-base"></span>
