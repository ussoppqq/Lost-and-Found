  ...
  <div class="mx-auto w-full px-4 max-w-lg lg:max-w-5xl">
    ...
    <div class="w-full bg-white rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-8">
      ...
      <div class="text-center mb-6">
        <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gray-800 shadow mb-3" aria-hidden="true">
          ...
          <div class="rounded-2xl border border-gray-200 bg-white/70 p-5">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-2xl p-5 mb-4 shadow-sm">
              ...
              <div class="flex gap-2">
                <button 
                  type="button" 
                  wire:click="verifyOtpAndProceed"
...
{{-- ==== JS: download PDF + cooldown tombol + lock submit ==== --}}
@once
<script>
  ...
  // --- Cegah Enter memicu submit tak sengaja di input text
