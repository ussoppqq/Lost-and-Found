    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl my-8 transform transition-all max-h-[90vh] overflow-y-auto">
        ...
        <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-indigo-50 sticky top-0 z-10">
            <div class="flex items-center justify-between">
                ...
                <button 
                    type="button"
                    wire:click="$dispatch('closeClaimModal')"
        ...
        <form wire:submit.prevent="processClaim">
            <div class="px-6 py-6 space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-900 mb-2">
                        Verification Photos <span class="text-red-500">*</span>
                    </label>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-yellow-700">
                                ...
                                Please ensure all photos are clear and properly document the return process.
                            </p>
                        </div>
                    </div>
                </div>
