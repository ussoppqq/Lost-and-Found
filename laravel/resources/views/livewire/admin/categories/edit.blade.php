                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 max-h-96 overflow-y-auto">
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    @error('category_name') <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    @error('retention_days') <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-5 gap-2">
                                        @foreach($availableIcons as $availIcon)
                                            <button type="button" wire:click.prevent="$set('category_icon', '{{ $availIcon }}')"
                                    ...
                                    @error('category_icon') <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        </div>
