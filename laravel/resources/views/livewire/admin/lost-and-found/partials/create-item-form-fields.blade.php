    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            @if($report_type === 'LOST')
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <span class="text-xs text-gray-500 font-normal ml-2">Max 2MB each</span>
                    </label>
                    <div
                        class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-orange-300 border-dashed rounded-lg hover:border-orange-400 transition bg-orange-50">
                        <div class="space-y-1 text-center">
                            ...
                            <p class="text-xs text-orange-600 font-medium">Optional: Upload photos from your archive/memory</p>
                        </div>
                    </div>
                    @error('photos.*') <span class="text-red-500 text-xs mt-2 block">{{ $message }}</span> @enderror

                    <!-- Loading Indicator -->
                    <div wire:loading wire:target="photos" class="mt-3 text-center">
                        <div class="inline-flex items-center px-4 py-2 bg-orange-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                @foreach($photos as $index => $photo)
                                    <div class="relative group">
                                        ...
                                        <div
                                            class="absolute bottom-0 left-0 right-0 bg-orange-600 bg-opacity-75 text-white text-xs py-1 px-2 rounded-b-lg">
                                            Photo {{ $index + 1 }}
                                        </div>
                                    </div>
                                @endforeach
        ...
        @if($report_type === 'FOUND')
            ...
            <div class="sm:col-span-2">
                ...
                <div
                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-indigo-400 transition">
                    <div class="space-y-1 text-center">
