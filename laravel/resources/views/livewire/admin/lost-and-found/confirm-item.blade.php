                ...
                <div class="px-6 py-6 max-h-[calc(100vh-12rem)] overflow-y-auto">
                    ...
                    <div class="mb-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200">
                        ...
                        <div class="mt-4 pt-4 border-t border-purple-200">
                            <label class="block text-xs font-medium text-gray-500 uppercase mb-2">Report Photos</label>
                            <div class="grid grid-cols-3 sm:grid-cols-4 gap-2">
                                @foreach($reportPhotos as $photoUrl)
                                    @if(Storage::disk('public')->exists($photoUrl))
                                    <img src="{{ Storage::url($photoUrl) }}" 
                                         class="w-full h-24 object-cover rounded-lg border-2 border-purple-200"
                                         alt="Report photo">
                                    @endif
                                @endforeach
                            </div>
                            <p class="text-xs text-gray-500 mt-2">These photos will be copied to the item record</p>
                        </div>
                        @endif
                    </div>
                    @endif
