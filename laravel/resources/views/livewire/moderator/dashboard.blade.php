    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('moderator.categories') }}" class="text-sm text-green-600 hover:text-green-800">
                    View all →
                </a>
            </div>
        </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">
                                            {{ $report->item?->item_name ?? 'No Item Linked' }}
                                        </div>
                                ...
                                <div class="flex items-center">
                                    @if($report->user)
                                        <img class="w-8 h-8 rounded-full mr-3"
                                            src="https://ui-avatars.com/api/?name={{ urlencode($report->user->full_name) }}&background=15803d&color=fff"
                                            alt="">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                ...
                                <p class="text-sm text-gray-500">No recent lost or found reports available.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
