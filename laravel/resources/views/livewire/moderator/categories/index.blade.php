<div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div>
                <a href="{{ route('moderator.categories.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 flex items-center">
            ...
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('moderator.categories.edit', $category->id) }}" class="text-indigo-600 hover:text-indigo-900">
