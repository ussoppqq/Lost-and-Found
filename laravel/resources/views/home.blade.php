    ...
    <section class="relative w-full h-screen overflow-hidden">
        ...
        <div
            ...
            <form action="{{ url('/search') }}" method="GET"
                ...
                {{-- Search Input --}}
                <input type="text" name="q" placeholder="Search....." class="font-openSans flex-1 pl-12 lg:pl-16 pr-24 lg:pr-32 h-full bg-transparent text-gray-700 placeholder:text-gray-400 
