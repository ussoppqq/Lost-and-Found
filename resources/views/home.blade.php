            ...
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-7xl w-full max-h-[92vh] overflow-hidden">
                ...
                <!-- Map Area (NO SCROLL + DRAG PAN) -->
                    <div class="relative overflow-hidden bg-gray-100" style="height: calc(92vh - 150px);">
                        ...
                        <!-- Viewport (NO SCROLL) -->
                        <div id="mapScrollContainer" class="w-full h-full overflow-hidden relative map-viewport">
                            <!-- Inner (di-transform: translate + scale) -->
                            <div id="mapInner" class="absolute top-0 left-0" style="width: 1400px;">
                                ...
                                {{-- ====== EXAMPLE PINS (ubah koordinat top/left sesuai kebutuhan) ====== --}}

                                <!-- Gerbang Utama -->
                                <div class="absolute pin-marker" style="top: 20%; left: 30%; --pin: 37, 99, 235;">
                                    <div class="pin-dot"></div>
                                    <div class="pin-tooltip">
                                        <div class="font-semibold text-blue-600">1. Gerbang Utama</div>
                                        <div class="text-xs text-gray-600">Main Gate</div>
                                    </div>
                                </div>

                                <!-- Museum Zoology -->
                                <div class="absolute pin-marker" style="top: 35%; left: 40%; --pin: 37, 99, 235;">
                                    <div class="pin-dot"></div>
                                    <div class="pin-tooltip">
                                        <div class="font-semibold text-blue-600">3. Museum Zoology</div>
                                        <div class="text-xs text-gray-600">Educational Facility</div>
                                    </div>
                                </div>

                                <!-- Monumen Lady Raffles -->
                                <div class="absolute pin-marker" style="top: 45%; left: 55%; --pin: 147, 51, 234;">
                                    <div class="pin-dot"></div>
                                    <div class="pin-tooltip">
                                        <div class="font-semibold text-purple-600">27. Monumen Lady Raffles</div>
                                        <div class="text-xs text-gray-600">Historical Monument</div>
                                    </div>
                                </div>

                                <!-- Taman Meksiko -->
                                <div class="absolute pin-marker" style="top: 60%; left: 35%; --pin: 22, 163, 74;">
                                    <div class="pin-dot"></div>
                                    <div class="pin-tooltip">
                                        <div class="font-semibold text-green-600">47. Taman Meksiko</div>
                                        <div class="text-xs text-gray-600">Koleksi Kaktus</div>
                                    </div>
                                </div>

                                <!-- Kolam Gunting -->
                                <div class="absolute pin-marker" style="top: 50%; left: 65%; --pin: 147, 51, 234;">
                                    <div class="pin-dot"></div>
                                    <div class="pin-tooltip">
                                        <div class="font-semibold text-purple-600">29. Kolam Gunting</div>
                                        <div class="text-xs text-gray-600">Scenic Pond</div>
                                    </div>
                                </div>

                                {{-- Tambah pin lain tinggal copy 1 blok di atas & ubah top/left + teks --}}
                            </div>
                        </div>
                    </div>
