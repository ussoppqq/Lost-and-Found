    ...
    <div class="mx-auto w-full px-4 max-w-lg lg:max-w-3xl">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-full px-4 py-3 pr-12 text-sm font-mono rounded-xl border-2 border-gray-300 focus:border-gray-800 focus:ring-2 focus:ring-gray-800 placeholder:text-gray-400"
                            maxlength="36"
                        />
                ...
                <div class="flex gap-3">
                    <button
                        ...
                        class="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gray-800 text-white font-semibold hover:bg-gray-900 active:scale-[0.98] transition-all shadow-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        class="px-6 py-3 rounded-xl bg-white border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 active:scale-[0.98] transition-all">
                        Reset
                    </button>
                </div>
            </div>

            <!-- Error Message from Session (404/invalid ID redirects) -->
            @if(session('error'))
        ...
        <div class="space-y-4">
            ...
            <a href="{{ route('tracking.detail', ['reportId' => $report->report_id]) }}"
               class="block bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all p-5 group">
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <!-- View Details Arrow -->
                        <div class="mt-2 flex items-center text-gray-700 text-xs font-semibold group-hover:gap-2 transition-all">
