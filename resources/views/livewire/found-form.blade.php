          ...
          <div class="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            <div>
              ...
              <div wire:key="upload-{{ $uploadKey }}-d">
                ...
                <input type="file" accept="image/*" capture="environment" class="hidden" wire:model="newPhotos" id="foundPhotosCamera_d">
              </div>
                ...
                @if(count($photos) < 5)
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-1 gap-3">
                    ...
                    <button type="button" onclick="document.getElementById('foundPhotos_d').click()"
                      class="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 bg-white hover:bg-gray-50 active:bg-gray-100 p-6 transition">
                      ...
                      <div class="text-center">
                        <p class="text-sm font-semibold text-gray-700">Upload</p>
                        <p class="text-xs text-gray-500 mt-0.5">From gallery</p>
                      </div>
                    </button>

                    {{-- Take Photo with Camera (Mobile Only) --}}
                    <button type="button" onclick="document.getElementById('foundPhotosCamera_d').click()"
                      class="md:hidden flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 hover:bg-blue-100 active:bg-blue-200 p-6 transition">
                      ...
                      <div class="text-center">
                        <p class="text-sm font-semibold text-blue-700">Camera</p>
                        <p class="text-xs text-blue-600 mt-0.5">Take photo</p>
                      </div>
                    </button>
                  </div>
                  <p class="text-center text-xs text-gray-500 mt-2">
                    @if(empty($photos)) Add photos (0/5) @else {{ count($photos) }}/5 photos added @endif
          ...
          <div class="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            <div class="mb-4">
              ...
              <div wire:key="upload-{{ $uploadKey }}-m">
                ...
                <input type="file" accept="image/*" capture="environment" class="hidden" wire:model="newPhotos" id="foundPhotosCamera_m">
              </div>
              ...
              <div class="space-y-3">
                ...
                @if(count($photos) < 5)
                  {{-- Upload/Camera Options for Mobile --}}
                  <div class="grid grid-cols-2 gap-3">
                    ...
                    <button type="button" onclick="document.getElementById('foundPhotosCamera_m').click()"
                      class="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 hover:bg-blue-100 active:bg-blue-200 p-6 transition">
                      <div class="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
